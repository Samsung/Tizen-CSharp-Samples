...
namespace Downloader.Tizen.Mobile
{
    ...
    public class DownloadImplementation : IDownload
    {
        ...
        private void StateChanged(object s, StateChangedEventArgs e)
        {
            String stateMsg = "";
            ...
            DownloadStateChanged(s, new DownloadStateChangedEventArgs(stateMsg));
        }
        ...
        private void ProgressChanged(object s, ProgressChangedEventArgs e)
        {
            if (e.ReceivedDataSize > 0)
            {
                DownloadProgress(s, new DownloadProgressEventArgs(e.ReceivedDataSize));
            }
        }
    }
}