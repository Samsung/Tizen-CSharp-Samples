...
namespace Weather.Service
{
    ...
    public class CityProvider : ICityProvider
    {
        ...
        {
            return CityList.Where(cityItem => cityItem.Name.StartsWith(text)).Take(n).ToList();
        }
        ...
        {
            return CityList
                .Where(cityItem => cityItem.Name.StartsWith(text) && cityItem.CountryCode.Equals(countryCode)).Take(n)
                .ToList();
        }
