...
{
    /// <summary>
    /// InVehicleActivityDetector Adapter class
    /// </summary>
    class InVehicleActivityDetectorAdapter : ISensorAdapter
    {
        private InVehicleActivityDetector sensor = null;
        EventHandler<InVehicleActivityDetectorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of InVehicleActivityDetectorAdapter.
        /// </summary>
        public InVehicleActivityDetectorAdapter()
        {
            sensor = new InVehicleActivityDetector
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of InVehicleActivityDetectorAdapter.
        /// </summary>
        ~InVehicleActivityDetectorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.InVehicleActivityDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.InVehicle }));
            };
