...
{
    /// <summary>
    /// ProximitySensor Adapter class
    /// </summary>
    class ProximitySensorAdapter : ISensorAdapter
    {
        private ProximitySensor sensor = null;
        EventHandler<ProximitySensorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of ProximitySensorAdapter.
        /// </summary>
        ~ProximitySensorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.ProximitySensorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.Proximity }));
            };
