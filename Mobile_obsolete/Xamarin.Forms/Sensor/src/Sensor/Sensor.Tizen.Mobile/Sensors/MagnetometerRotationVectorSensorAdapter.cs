...
{
    /// <summary>
    /// MagnetometerRotationVectorSensor Adapter class
    /// </summary>
    class MagnetometerRotationVectorSensorAdapter : ISensorAdapter
    {
        private MagnetometerRotationVectorSensor sensor = null;
        EventHandler<MagnetometerRotationVectorSensorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of MagnetometerRotationVectorSensorAdapter.
        /// </summary>
        public MagnetometerRotationVectorSensorAdapter()
        {
            sensor = new MagnetometerRotationVectorSensor
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of MagnetometerRotationVectorSensorAdapter.
        /// </summary>
        ~MagnetometerRotationVectorSensorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.MagnetometerRotationVectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.X, e.Y, e.Z, e.W }));
            };
