...
{
    /// <summary>
    /// Accelerometer Adapter class
    /// </summary>
    class AccelerometerAdapter : ISensorAdapter
    {
        private Accelerometer sensor = null;
        EventHandler<AccelerometerDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of AccelerometerAdapter.
        /// </summary>
        ...
        /// <summary>
        /// Destructor of AccelerometerAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.AccelerometerType,
            Name = sensor.Name,
