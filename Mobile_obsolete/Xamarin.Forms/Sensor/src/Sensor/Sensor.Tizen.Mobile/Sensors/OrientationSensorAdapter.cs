...
{
    /// <summary>
    /// OrientationSensor Adapter class
    /// </summary>
    class OrientationSensorAdapter : ISensorAdapter
    {
        private OrientationSensor sensor = null;
        EventHandler<OrientationSensorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of OrientationSensorAdapter.
        /// </summary>
        ~OrientationSensorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.OrientationSensorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.Azimuth, e.Pitch, e.Roll }));
            };
