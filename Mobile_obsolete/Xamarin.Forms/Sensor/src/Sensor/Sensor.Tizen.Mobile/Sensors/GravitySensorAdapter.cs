...
{
    /// <summary>
    /// GravitySensor Adapter class
    /// </summary>
    class GravitySensorAdapter : ISensorAdapter
    {
        private GravitySensor sensor = null;
        EventHandler<GravitySensorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of GravitySensorAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.GravitySensorType,
            Name = sensor.Name,
