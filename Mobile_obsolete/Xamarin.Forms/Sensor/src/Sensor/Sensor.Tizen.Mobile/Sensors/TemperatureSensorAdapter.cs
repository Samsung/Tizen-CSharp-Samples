...
{
    /// <summary>
    /// TemperatureSensor Adapter class
    /// </summary>
    class TemperatureSensorAdapter : ISensorAdapter
    {
        private TemperatureSensor sensor = null;
        EventHandler<TemperatureSensorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of TemperatureSensorAdapter.
        /// </summary>
        ...
        /// <summary>
        /// Destructor of TemperatureSensorAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.TemperatureSensorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.Temperature }));
            };
