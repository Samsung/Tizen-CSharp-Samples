...
{
    /// <summary>
    /// PickUpGestureDetector Adapter class
    /// </summary>
    class PickUpGestureDetectorAdapter : ISensorAdapter
    {
        private PickUpGestureDetector sensor = null;
        EventHandler<PickUpGestureDetectorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of PickUpGestureDetectorAdapter.
        /// </summary>
        ~PickUpGestureDetectorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.PickUpGestureDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.PickUp }));
            };
