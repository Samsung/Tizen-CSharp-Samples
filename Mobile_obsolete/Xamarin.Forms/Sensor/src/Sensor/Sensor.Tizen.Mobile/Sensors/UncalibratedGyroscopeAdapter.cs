...
{
    /// <summary>
    /// UncalibratedGyroscope Adapter class
    /// </summary>
    class UncalibratedGyroscopeAdapter : ISensorAdapter
    {
        private UncalibratedGyroscope sensor = null;
        EventHandler<UncalibratedGyroscopeDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of UncalibratedGyroscopeAdapter.
        /// </summary>
        public UncalibratedGyroscopeAdapter()
        {
            sensor = new UncalibratedGyroscope
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of UncalibratedGyroscopeAdapter.
        /// </summary>
        ~UncalibratedGyroscopeAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.UncalibratedGyroscopeType,
            Name = sensor.Name,
