...
{
    /// <summary>
    /// WalkingActivityDetector Adapter class
    /// </summary>
    class WalkingActivityDetectorAdapter : ISensorAdapter
    {
        private WalkingActivityDetector sensor = null;
        EventHandler<WalkingActivityDetectorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of WalkingActivityDetectorAdapter.
        /// </summary>
        public WalkingActivityDetectorAdapter()
        {
            sensor = new WalkingActivityDetector
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of WalkingActivityDetectorAdapter.
        /// </summary>
        ~WalkingActivityDetectorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.WalkingActivityDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.Walking }));
            };
