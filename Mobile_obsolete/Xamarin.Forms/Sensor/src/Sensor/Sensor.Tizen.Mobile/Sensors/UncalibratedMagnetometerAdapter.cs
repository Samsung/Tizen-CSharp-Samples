...
{
    /// <summary>
    /// UncalibratedMagnetometer Adapter class
    /// </summary>
    class UncalibratedMagnetometerAdapter : ISensorAdapter
    {
        private UncalibratedMagnetometer sensor = null;
        EventHandler<UncalibratedMagnetometerDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of UncalibratedMagnetometerAdapter.
        /// </summary>
        public UncalibratedMagnetometerAdapter()
        {
            sensor = new UncalibratedMagnetometer
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of UncalibratedMagnetometerAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.UncalibratedMagnetometerType,
            Name = sensor.Name,
