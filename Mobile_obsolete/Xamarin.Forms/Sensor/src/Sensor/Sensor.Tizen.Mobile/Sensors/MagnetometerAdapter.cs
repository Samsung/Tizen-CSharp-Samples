...
{
    /// <summary>
    /// Magnetometer Adapter class
    /// </summary>
    class MagnetometerAdapter : ISensorAdapter
    {
        private Magnetometer sensor = null;
        EventHandler<MagnetometerDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of MagnetometerAdapter.
        /// </summary>
        ~MagnetometerAdapter()
        {
            sensor.Dispose();
        ...
        {
            Type = SensorTypes.MagnetometerType,
            Name = sensor.Name,
