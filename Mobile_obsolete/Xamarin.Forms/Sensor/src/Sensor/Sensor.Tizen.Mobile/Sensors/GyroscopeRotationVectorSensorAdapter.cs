...
{
    /// <summary>
    /// GyroscopeRotationVectorSensor Adapter class
    /// </summary>
    class GyroscopeRotationVectorSensorAdapter : ISensorAdapter
    {
        private GyroscopeRotationVectorSensor sensor = null;
        EventHandler<GyroscopeRotationVectorSensorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of GyroscopeRotationVectorSensorAdapter.
        /// </summary>
        public GyroscopeRotationVectorSensorAdapter()
        {
            sensor = new GyroscopeRotationVectorSensor
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of GyroscopeRotationVectorSensorAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.GyroscopeRotationVectorType,
            Name = sensor.Name,
