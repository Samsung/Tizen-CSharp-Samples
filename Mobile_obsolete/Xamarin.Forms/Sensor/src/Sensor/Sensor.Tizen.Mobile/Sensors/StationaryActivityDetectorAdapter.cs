...
{
    /// <summary>
    /// StationaryActivityDetector Adapter class
    /// </summary>
    class StationaryActivityDetectorAdapter : ISensorAdapter
    {
        private StationaryActivityDetector sensor = null;
        EventHandler<StationaryActivityDetectorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of StationaryActivityDetectorAdapter.
        /// </summary>
        public StationaryActivityDetectorAdapter()
        {
            sensor = new StationaryActivityDetector
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of StationaryActivityDetectorAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.StationaryActivityDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.Stationary }));
            };
