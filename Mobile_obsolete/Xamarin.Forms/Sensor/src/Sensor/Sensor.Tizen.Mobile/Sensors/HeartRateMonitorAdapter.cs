...
{
    /// <summary>
    /// HeartRateMonitor Adapter class
    /// </summary>
    class HeartRateMonitorAdapter : ISensorAdapter
    {
        private HeartRateMonitor sensor = null;
        EventHandler<HeartRateMonitorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of HeartRateMonitorAdapter.
        /// </summary>
        public HeartRateMonitorAdapter()
        {

        }

        /// <summary>
        /// Destructor of HeartRateMonitorAdapter.
        /// </summary>
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.HeartRate }));
            };
