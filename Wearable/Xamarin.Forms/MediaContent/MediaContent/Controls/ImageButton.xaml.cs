...
namespace MediaContent.Controls
{
    ...
    public partial class ImageButton : Image
    {
        ...
        /// <summary>
        /// Gets or sets a command that will be executed if the button is touched. 
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a command parameter that will be passed when the Command is executed. 
        /// </summary>
