...
{
    /// <summary>
    /// Converter class to convert place type enum to image source string.
    /// </summary>
    public class PlaceTypeToImageSourceConverter : IValueConverter
    {
        #region methods
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return $"images/{place.GetFilename()}";
            }
