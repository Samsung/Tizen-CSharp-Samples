...
namespace PlayerSample
{
    ...
    public interface IMediaPlayer
    {
        ...
        /// </summary>
        MediaPlayerRotation Rotation { get; set; }

        /// <summary>
        /// Sets and gets the display mode.
        /// </summary>
        MediaPlayerDisplayMode DisplayMode { get; set; }

        /// <summary>
        /// Sets and gets the audio latency mode.
        /// </summary>
        int AudioLatencyMode { get; set; }

        /// <summary>
        /// Retrieves the stream information of media.
        /// </summary>
        /// <returns>Stream's info.</returns>
        IEnumerable<Property> GetStreamInfo();

        /// <summary>
        /// Retrieves the content information of media.
        /// </summary>
        /// <returns>Content's information.</returns>
        IEnumerable<Property> GetMetaData();

        /// <summary>
        /// Creates the display for player.
        /// </summary>
        void CreateDisplay();
        ...
        void ApplyAudioStreamPolicy(Tizen.Multimedia.AudioStreamPolicy audioStreamPolicy);
