...
{
    /// <summary>
    /// Converter class to convert uv level enum to description.
    /// </summary>
    public class UvLevelToDescription : IValueConverter
    {
        /// <summary>
        /// Convert UvLevel value to description string value.
        /// </summary>
