...
{
    /// <summary>
    /// FaceDownGestureDetector Adapter class
    /// </summary>
    class FaceDownGestureDetectorAdapter : ISensorAdapter
    {
        private FaceDownGestureDetector sensor = null;
        EventHandler<FaceDownGestureDetectorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of FaceDownGestureDetectorAdapter.
        /// </summary>
        public FaceDownGestureDetectorAdapter()
        {
            sensor = new FaceDownGestureDetector
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of FaceDownGestureDetectorAdapter.
        /// </summary>
        ~FaceDownGestureDetectorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.FaceDownGestureDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.FaceDown }));
            };
