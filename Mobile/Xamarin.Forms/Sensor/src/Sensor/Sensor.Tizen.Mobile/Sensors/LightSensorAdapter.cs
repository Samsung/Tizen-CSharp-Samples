...
{
    /// <summary>
    /// LightSensor Adapter class
    /// </summary>
    class LightSensorAdapter : ISensorAdapter
    {
        private LightSensor sensor = null;
        EventHandler<LightSensorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of LightSensorAdapter.
        /// </summary>
        ~LightSensorAdapter()
        {
            sensor.Dispose();
        ...
        {
            Type = SensorTypes.LightSensorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.Level }));
            };
