...
{
    /// <summary>
    /// PressureSensor Adapter class
    /// </summary>
    class PressureSensorAdapter : ISensorAdapter
    {
        private PressureSensor sensor = null;
        EventHandler<PressureSensorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of PressureSensorAdapter.
        /// </summary>
        ...
        /// <summary>
        /// Destructor of PressureSensorAdapter.
        /// </summary>
        ...
        {
            Type = SensorTypes.PressureSensorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { e.Pressure }));
            };
