...
{
    /// <summary>
    /// RotationVectorSensor Adapter class
    /// </summary>
    class RotationVectorSensorAdapter : ISensorAdapter
    {
        private RotationVectorSensor sensor = null;
        EventHandler<RotationVectorSensorDataUpdatedEventArgs> handler = null;
        ...
        /// <summary>
        /// Destructor of RotationVectorSensorAdapter.
        /// </summary>
        ~RotationVectorSensorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.RotationVectorSensorType,
            Name = sensor.Name,
