...
{
    /// <summary>
    /// PercentageSliderWithDescription class.
    /// Provides logic for PercentageSliderWithDescription.
    /// This class defines a slider item which contains a label at the top-left corner (title),
    /// a label at the top-right corner (describing slider value in percentages)
    /// and a slider at the bottom.
    /// </summary>
    public partial class PercentageSliderWithDescription
    {
        #region properties
        ...
        public static readonly BindableProperty SliderValueProperty =
            BindableProperty.Create(nameof(SliderValue), typeof(double), typeof(PercentageSliderWithDescription),
                default(double),
                BindingMode.TwoWay, propertyChanged: OnSliderValuePropertyChanged);

        /// <summary>
        /// The value of the PercentageSliderWithDescription's slider.
        /// </summary>
        ...
        /// <summary>
        /// PercentageSliderWithDescription class constructor.
        /// Initializes component and registers an event handler to respond
        /// to slider's 'ValueChanged' event.
        /// </summary>
        public PercentageSliderWithDescription()
        {
            InitializeComponent();

            ValueSlider.ValueChanged += (sender, e) => { SliderValue = e.NewValue; };
        }

        /// <summary>
        /// Sets PercentageSliderWithDescription's slider value.
        /// </summary>
        ...
        {
            if (bindable is PercentageSliderWithDescription button)
            {
