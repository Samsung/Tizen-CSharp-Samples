...
namespace NotificationManager.Navigation
{
    /// <summary>
    ...
    public class PageNavigation
    {
        ...
        /// Creates an instance of 'pageType' class and pushes it to the page
        /// navigation stack.
        /// </summary>
        /// <param name="navigation">An instance of an object that implements INavigation interface.</param>
        public PageNavigation(INavigation navigation)
        {
            NavigateToCommand = new Command<Type>(async pageType =>
            {
