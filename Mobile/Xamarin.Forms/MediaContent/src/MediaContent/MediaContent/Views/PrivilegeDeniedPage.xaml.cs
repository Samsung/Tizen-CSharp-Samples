...
namespace MediaContent.Views
{
    ...
    /// </summary>
    public partial class PrivilegeDeniedPage : ContentPage
    {
        #region fields
        ...
        public static BindableProperty ConfirmCommandProperty =
            BindableProperty.Create(nameof(ConfirmCommand), typeof(Command), typeof(PrivilegeDeniedPage));
