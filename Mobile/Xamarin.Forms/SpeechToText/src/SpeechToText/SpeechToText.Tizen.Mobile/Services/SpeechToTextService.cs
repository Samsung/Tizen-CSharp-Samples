...
using SpeechToText.Tizen.Mobile.Services;
...
namespace SpeechToText.Tizen.Mobile.Services
{
    ...
    /// <summary>
    /// STT service implementation for Tizen platform.
    /// </summary>
    class SpeechToTextService : ISpeechToTextService
    {
        ...
        private void PrivilegeManagerOnResponseFetched(object sender, RequestResponseEventArgs requestResponseEventArgs)
        {
            ...
            {
                Log.Error("STT", "Error occurred during requesting permission");
