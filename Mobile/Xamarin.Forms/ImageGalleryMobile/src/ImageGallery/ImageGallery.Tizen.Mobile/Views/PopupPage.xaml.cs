...
{
    /// <summary>
    /// Provides popup page, which is displayed when privileges,
    /// required by the application, were not granted.
    /// </summary>
    ...
    public partial class PopupPage : ContentPage
    {
        ...
        public static BindableProperty ConfirmCommandProperty =
            BindableProperty.Create(nameof(ConfirmCommand), typeof(Command), typeof(PopupPage));
        ...
        /// <summary>
        /// Initializes PopupPage class instance.
        /// </summary>
        public PopupPage()
        {
            InitializeComponent();
