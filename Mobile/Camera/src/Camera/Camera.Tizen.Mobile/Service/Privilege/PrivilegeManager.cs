...
namespace Camera.Tizen.Mobile.Service.Privilege
{
    /// <summary>
    /// Class which stores list of application privileges and manages their status.
    /// This is singleton. Instance is accessible via <see cref="Instance">Instance</see> property.
    /// </summary>
    public sealed class PrivilegeManager
    {
        ...
        /// <summary>
        /// The camera privilege.
        /// </summary>
        private const string CAMERA_PRIVILEGE = "http://tizen.org/privilege/camera";

        /// <summary>
        /// The media storage privilege.
        /// </summary>
        ...
        private readonly List<PrivilegeItem> _privilegeItems = new List<PrivilegeItem>
            {
                new PrivilegeItem(CAMERA_PRIVILEGE),
                new PrivilegeItem(MEDIASTORAGE_PRIVILEGE)
            };
