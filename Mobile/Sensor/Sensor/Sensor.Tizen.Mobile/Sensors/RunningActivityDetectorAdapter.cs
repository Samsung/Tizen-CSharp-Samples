...
{
    /// <summary>
    /// RunningActivityDetector Adapter class
    /// </summary>
    class RunningActivityDetectorAdapter : ISensorAdapter
    {
        private RunningActivityDetector sensor = null;
        EventHandler<RunningActivityDetectorDataUpdatedEventArgs> handler = null;

        /// <summary>
        /// Constructor of RunningActivityDetectorAdapter.
        /// </summary>
        public RunningActivityDetectorAdapter()
        {
            sensor = new RunningActivityDetector
            {
                Interval = 100,
        ...
        /// <summary>
        /// Destructor of RunningActivityDetectorAdapter.
        /// </summary>
        ~RunningActivityDetectorAdapter()
        {
            sensor.Dispose();
        }
        ...
        {
            Type = SensorTypes.RunningActivityDetectorType,
            Name = sensor.Name,
        ...
        public void Start(EventHandler<SensorEventArgs> listener)
        {
            handler = (sender, e) =>
            {
                listener?.Invoke(this,
                    new SensorEventArgs(new List<float>() { (int)e.Running }));
            };
