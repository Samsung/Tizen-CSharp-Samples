...
namespace ImageUtilSample
{
    ...
    class ListPageViewModel : ViewModelBase
    {
        ...
        private void LoadImages()
        {
            ...
            foreach (var path in DependencyService.Get<IMediaContentDatabase>().SelectImages())
            {
                Items.Add(path);
            }
        }
        ...
        public ListPageViewModel()
        {
            ...
            {
                DependencyService.Get<IImageUtil>().ImagePath = SelectedItem;
