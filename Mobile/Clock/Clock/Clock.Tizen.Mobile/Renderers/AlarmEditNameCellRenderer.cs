...
[assembly: ExportCell(typeof(AlarmEditNameCell), typeof(AlarmEditNameCellRenderer))]
...
namespace Clock.Tizen.Mobile.Renderers
{
    ...
    /// </summary>
    public class AlarmEditNameCellRenderer : CellRenderer
    {
        /// <summary>
        /// The constructor.
        /// </summary>
        public AlarmEditNameCellRenderer() : base("full")
        {
        ...
        protected override EvasObject OnGetContent(Cell cell, string part)
        {
            ...
            {
                var viewCell = (AlarmEditNameCell)cell;
        ...
        protected double FindCellContentHeight(AlarmEditNameCell cell)
        {
            AlarmEditNameCell viewCell = cell as AlarmEditNameCell;
            if (viewCell != null)
            {
