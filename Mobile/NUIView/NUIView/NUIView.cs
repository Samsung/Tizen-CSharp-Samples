...
namespace NUIView
{
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            // _textLabel.BackgroundColor = new Color(0.2f, 0.2f, 0.2f, 1.0f);
            ...
            // _textLabel.WidthResizePolicy = ResizePolicyType.FillToParent;
            // _textLabel.HeightResizePolicy = ResizePolicyType.SizeRelativeToParent;
            // _textLabel.SetSizeModeFactor(new Vector3(0.0f, 0.2f, 0.0f));
