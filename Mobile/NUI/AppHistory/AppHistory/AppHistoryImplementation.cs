...
namespace AppHistory
{
    ...
    static public class AppHistoryImplementation
    {
        ...
        static public List<StatsInfoItem> QueryRecentlyUsedApplications()
        {
            try
            {
        ...
        /// </summary>
        /// <returns>List of application history information</returns>
        static public List<StatsInfoItem> QueryFrequentlyUsedApplications()
        {
            try
            {
        ...
        /// </summary>
        /// <returns>List of application history information</returns>
        static public List<StatsInfoItem> QueryBatteryConsumingApplications()
        {
            try
            {
