...
[assembly: Dependency(typeof(RecorderSecurity))]
namespace RecorderSample.Tizen.Mobile
{
    class RecorderSecurity : IRecorderSecurity
    {
        /// <summary>
        /// Check privilege.
        /// </summary>
        ...
        public void CheckPrivilege(string privilege)
        {
            ...
            switch (result)
            {
                case CheckResult.Allow:
                    Log.Info("RecorderSample", $"Privilege \"{privilege}\" : allowed.");
                    /// Privilege can be used
                    break;
                case CheckResult.Deny:
                    Log.Info("RecorderSample", $"Privilege \"{privilege}\" : denied.");
