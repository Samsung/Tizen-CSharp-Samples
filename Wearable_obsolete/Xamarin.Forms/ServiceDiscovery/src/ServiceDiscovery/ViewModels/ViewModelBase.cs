...
namespace ServiceDiscovery.ViewModels
{
    ...
    public class ViewModelBase : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Event called when alert should be displayed.
        /// </summary>
        public event EventHandler<AlertCreatedEventArgs> AlertCreated;

        /// <summary>
        /// Function raises Alert created event.
        /// </summary>
        /// <param name="title"> Alert title </param>
        /// <param name="message"> Alert message </param>
        protected void CreateAlert(string title, string message)
        {
            AlertCreated?.Invoke(this, new AlertCreatedEventArgs(title, message));
        }
    ...
    /// <summary>
    /// Class containg data passed in AlertCreated event.
    /// </summary>
    public class AlertCreatedEventArgs
    {
        public string title;
        public string message;

        /// <summary>
        /// AlertCreatedEventArgs constructor.
        /// </summary>
        /// <param name="title"> Alert title </param>
        /// <param name="message"> Alert message </param>
        public AlertCreatedEventArgs(string title, string message)
        {
            this.title = title;
