...
namespace Calculator.Models
{
    ...
    public static class Operators
    {
            ...
            InputElement addingElement)
        {
            ...
            {
                IOperator inputOper = GetOperator(addingElement);
            ...
            OperandType.BOTH == lastOper.OperandType)
            {
                ...
                {
                    res = IsPossibleCombineWithOperandOperatorRightBoth(addingElement, out isMultiplyRequird);
                }

                else
                {
                    res = IsPossibleCombineWithOperatorRightBoth(addingElement, out isMultiplyRequird);
                }
            }
            else if (OperandType.LEFT == lastOper.OperandType)
            {
                if (lastOper is IUnaryOperator)
                {
                    res = IsPossibleCombineWithOperandOperatorLeft(addingElement, out isMultiplyRequird);
                }

                else
                {
                    res = IsPossibleCombineWithOperatorLeft(addingElement, out isMultiplyRequird);
                }
            }
            else if (OperandType.NONE == lastOper.OperandType)
            {
                res = IsPossibleCombineOperandOperatorWithNone(addingElement, out isMultiplyRequird);
            }
