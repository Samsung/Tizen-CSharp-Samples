...
namespace NUI_CheckBox
{
    ...
    /// </summary>
    internal class CustomCheckBoxStyle : ButtonStyle
    {
    ...
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            ImageURL = Current.DirectoryInfo.Resource + "images/";
            ...
            userTheme.AddStyle("_CustomCheckBoxStyle", new CustomCheckBoxStyle());
