...
namespace NUI_Visuals
{
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            Window.Default.BackgroundColor = Color.Blue;
            Size2D WindowinSize = Window.Default.WindowSize;
            ...
            Window.Default.Add(ButtonVisualView);
            ...
            Window.Default.Add(MainVisualView);
