...
namespace NUI_Pagination
{
    ...
    /// </summary>
    internal class CustomPaginationStyle : PaginationStyle
    {
        public CustomPaginationStyle()
        {
    ...
    class Program : NUIApplication
    {
        ...
        void Initialize()
        {
            ...
            Window.Default.TouchEvent += WindowTouchEvent;
            WindowWidth = (int)Window.Default.WindowSize[0];
            WindowHeight = (int)Window.Default.WindowSize[1];
            ...
            userTheme.AddStyle("CustomPagination", new CustomPaginationStyle());
