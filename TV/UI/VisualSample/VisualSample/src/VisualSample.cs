...
namespace VisualSample
{
    ...
    class VisualSample : NUIApplication
    {
        ...
        public void Initialize()
        {
            ...
            Window.Default.GetDefaultLayer().Add(guide);
            ...
            Window.Default.GetDefaultLayer().Add(_visualView);

            Populate();
            Window.Default.KeyEvent += AppBack;
        }

        /// <summary>
        /// This Application will be exited when back key entered.
        /// </summary>
        /// <param name="source">Window.Default</param>
        ...
        {
            Vector2 stagesize = Window.Default.Size;
            ...
            button.KeyEvent += (obj, ee) =>
            {
                if ("Return" == ee.Key.KeyPressedName)
                {
                    if (Key.StateType.Down == ee.Key.State)
                    {
                        ...
                        Tizen.Log.Info("Visual", "Press in pushButton sample!!!!!!!!!!!!!!!!");
                    }
                    else if (Key.StateType.Up == ee.Key.State)
                    {
                        button.BackgroundImage = focusImagePath;
                        Tizen.Log.Info("Visual", "Release in pushButton sample!!!!!!!!!!!!!!!!");
                    }
                }
        ...
        public bool IsSREmul()
        {
            ...
            int widthDpi = (int)Window.Default.Dpi.Width;
            int heightDpi = (int)Window.Default.Dpi.Height;
