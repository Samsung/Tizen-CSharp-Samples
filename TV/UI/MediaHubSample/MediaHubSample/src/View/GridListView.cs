...
namespace Tizen.NUI.MediaHub
{
    ...
    public class GridListView
    {
        ...
        {
            Tizen.Log.Info("MediaHub", "GridListView viewType:" + viewType);
        ...
        {
            Tizen.Log.Info("MediaHub", "[ListView]createList ");
            ...
            Tizen.Log.Info("MediaHub", "getGroups SetBridge");
        ...
        {
            Tizen.Log.Info("MediaHub", "[GridListView.cs@OnLinerKeyEventHandler]e.Key.State : " + e.Key.State + ";  e.Key.KeyPressedName : " + e.Key.KeyPressedName);
            bool ret = true;
