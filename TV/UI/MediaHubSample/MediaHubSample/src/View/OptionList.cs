    ...
    public class OptionList : View
    {
        ...
        public int SelectItemIndex
        {
            ...
            set
            {
                ...
                if (list != null)
                {
                    ...
                    {
                        Tizen.Log.Fatal("MediaHub", "Select item index is out of range! Items count = " + list.NumOfItem + ", index = " + value);
        ...
        public int FocusItemIndex
        {
            ...
            set
            {
                if (value < 0 || value >= list.NumOfItem)
                {
                    Tizen.Log.Fatal("MediaHub", "Focus item index is out of range! Items count = " + list.NumOfItem + ", index = " + value);
        ...
        public void RemoveData(int fromIndex, int removeNum = 1)
        {
            ...
            {
                Tizen.Log.Fatal("MediaHub", "Remove data index is out of range! Valid range is 0 to " + (list.NumOfItem - 1) + ", Remove range is " + fromIndex + " to " + (fromIndex + removeNum - 1));
        ...
        public void DisableItem(int index, bool disable = true)
        {
            ...
            {
                Tizen.Log.Fatal("MediaHub", "Disable item index is out of range! Items count = " + list.NumOfItem + ", index = " + index);
        ...
        public string TextString(int index)
        {
            if (index < 0 || index >= list.NumOfItem)
            {
                Tizen.Log.Fatal("MediaHub", "Item index is out of range! Items count = " + list.NumOfItem + ", index = " + index);
        ...
        private void OnUpdate()
        {
            ...
            // Tizen.Log.Info("MediaHub", " ...listMargin:" + listMargin[0] + ", " + listMargin[1] + ", " + listMargin[2] + ", " + listMargin[3]);
