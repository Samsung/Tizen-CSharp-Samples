...
namespace Tizen.NUI.MediaHub
{
    ...
    public class ThumbnailView : ImageItem
    {
        ...
        public void UnloadItem()
        {
            ...
            {
                Tizen.Log.Fatal("MediaHub", " thumbnail  UnloadItem InformationIconURLArray = null error" + err.Message);
            }
        ...
        {
            Tizen.Log.Info("MediaHub", "Thumbnail View showCheckBox editMode:" + editMode);
            if (!editMode)
            {
                return;
            }
            ...
            if (StateEnabled)
            {
                Tizen.Log.Info("MediaHub", "Thumbnail View showCheckBox StateEnabled:" + StateEnabled);
                StateEditabled = true;
