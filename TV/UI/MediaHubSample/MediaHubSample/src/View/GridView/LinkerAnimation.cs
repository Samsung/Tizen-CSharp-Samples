...
/// <summary>
/// namespace for Tizen.TV.NUI.Component package
/// </summary>
namespace Tizen.NUI
{
    /// <summary>
    ...
    /// </summary>
    /// <code>
    ///     scrollAni = new LinkerAnimation(itemGroup, scrollAniDuration, 100, 0.1f);
    /// </code>
    internal class LinkerAnimation
    {
        private List<Animation> scrollAniList;
