...
namespace Tizen.NUI.MediaHub
{
    ...
    public class ImageItem : View
    {
        ...
        private void ApplyMainText()
        {
            ...
            Tizen.Log.Info("MediaHub", "size, mainTextWidth= " + mainText.Size2D.Width + ", mainTextHeight = " + mainText.Size2D.Height);

            mainText.Position = new Position(20.0f, size.Height - 60.0f + (60.0f - 40.0f) / 2.0f, 0);
            Tizen.Log.Info("MediaHub", "position, x= " + mainText.Position.X + ", y = " + mainText.Position.Y);
        ...
        private void ApplyInformationIcon()
        {
            ...
            {
                Tizen.Log.Info("MediaHub", "informationIconArray/informationIconURLArray is null , return");
                return;
            }
        ...
        {
            Tizen.Log.Info("MediaHub", "isFocused = " + isFocused);
        ...
        {
            Tizen.Log.Info("MediaHub", "isSelected = " + isSelected);
            UpdateTextStyleByState();
        }
        ...
        {
            Tizen.Log.Info("MediaHub", "isEnabled = " + isEnabled);
            UpdateTextStyleByState();
            PlayDimAnimation();
        }
        ...
        private void UpdateMainTextStyleByState()
        {
            ...
            Tizen.Log.Info("MediaHub", "isFocused = " + isFocused + ", isSelected = " + isSelected + ", isEnabled = " + isEnabled);
            if (isFocused)
            {
        ...
        private void UpdateMainTextScroll()
        {
            ...
            if (enableScroll)
            {
                if (isFocused)
                {
                    ...
                    Tizen.Log.Info("MediaHub",  "naturalWidth = " + naturalWidth + ", settingWidth = " + settingWidth + ", enableScroll = " + enableScroll);
