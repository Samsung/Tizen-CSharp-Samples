...
namespace Tizen.NUI.MediaHub
{
    public class Dropdown : View
    {
        ...
        public void AddListData(string textString)
        {
            if (optionList != null)
            {
                Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown AddListData" + " ------]" + textString);
        ...
        public Size2D SetListSize
        {
            ...
            set
            {
                if (value == null)
                {
                    Tizen.Log.Fatal("MediaHub", "Set null value to the size of the list!");
        ...
        {
            Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown ShowList" + " ------]");
            ...
            Tizen.Log.Info("MediaHub", " [------" + "SelectItemIndex: " + optionList.SelectItemIndex + " FocusItemIndex: " + optionList.FocusItemIndex + " ListItemNumbers: " + ListItemNumbers);
            ...
            if (listOpenAni == null)
            {
                ...
                Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown ShowList" + " ------]" + optionList.Position.Y);
            }
        ...
        public void HideList()
        {
            ...
            {
                Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown HideList" + " ------]");
                listOpenAni.Stop();
            }
            ...
            listCloseAni.Play();
            Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown HideList listCloseAni" + " ------]");
        }
        ...
        {
            SetAttribute();
            Tizen.Log.Info("MediaHub", "..." + this.GetHashCode() + " Name:" + this.Name);
        }
        ...
        {
            Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown ViewFocusGained" + " ------]" + Name);
        ...
        {
            Tizen.Log.Info("MediaHub", " [------" + "enter into Dropdown Initiate" + " ------]");
            Relayout += OnRelayout;
        ...
        private bool OnListKeyPressed(object source, View.KeyEventArgs e)
        {
            if (e.Key.State == Key.StateType.Down && optionList != null)
            {
                ...
                {
                    Tizen.Log.Info("MediaHub", "dropdown Back before");
                    FocusManager.Instance.SetCurrentFocusView(dropdownButton);
                    HideList();
                }
