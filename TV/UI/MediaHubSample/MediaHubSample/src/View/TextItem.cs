...
namespace Tizen.NUI.MediaHub
{
    ...
    public class TextItem : View
    {
        ...
        public string MainText
        {
            ...
            set
            {
                Tizen.Log.Info("MediaHub", "value = " + value);
        ...
        {
            Relayout += OnRelayout;
            Tizen.Log.Info("MediaHub", "Create mandatory components");
            InitializeRootView();
            InitializeBGView();
        }
        ...
        {
            Tizen.Log.Info("MediaHub", "Create RootView");
            rootView = new View();
        ...
        {
            Tizen.Log.Info("MediaHub", "Create BGView");
        ...
        private void InitializeListLineView()
        {
            ...
            {
                Tizen.Log.Info("MediaHub", "Create ListLineView");
        ...
        private void InitializeMainText()
        {
            ...
            Tizen.Log.Info("MediaHub", "Create MainText");
        ...
        private void InitializeCheckIcon()
        {
            ...
            Tizen.Log.Info("MediaHub", "Create CheckIcon");
        ...
        {
            Tizen.Log.Info("MediaHub", "Apply Attributes");
            ApplyBgView();
            ApplyListLineView();
            ApplyCheckIcon();
            ApplyMainText();
        ...
        {
            Tizen.Log.Info("MediaHub", "Apply BGView");
            ...
            Tizen.Log.Info("MediaHub", "width = " + rootWidth + ", height = " + rootHeight + ", newWidth = " + newWidth + ", newHeight = " + newHeight);
        ...
        private void ApplyMainTextFontStyle()
        {
            ...
            Tizen.Log.Info("MediaHub", "Apply MainText FontStyle");
        ...
        private void ApplyMainTextScrollStyle()
        {
            ...
            Tizen.Log.Info("MediaHub", "Apply MainText ScrollStyle");
        ...
        private void UpdateMainTextScroll()
        {
            ...
            if (isFocused)
            {
                ...
                Tizen.Log.Info("MediaHub", "naturalWidth = " + naturalWidth + ", settingWidth = " + settingWidth);
        ...
        private void ApplyMainTextContent()
        {
            ...
            {
                Tizen.Log.Info("MediaHub", "mainTextContent = " + mainTextContent);
                mainText.Text = mainTextContent;
            }
        }
        ...
        {
            Tizen.Log.Info("MediaHub", "Apply Animation");
            InitializeAnimation();
            // focused
            ...
            if (backgroundView != null)
            {
                ...
                Tizen.Log.Info("MediaHub", "isFocused = " + isFocused + ", focusInOpacity = " + focusInOpacity + ", focusOutOpacity = " + focusOutOpacity);
                if (isFocused)
                {
            ...
            Tizen.Log.Info("MediaHub", "isEnabled = " + isEnabled + ", dimInOpacity = " + dimInOpacity + ", dimOutOpacity = " + dimOutOpacity);
            if (isEnabled)
            {
            ...
            Tizen.Log.Info("MediaHub", "selectedDuration = " + selectedDuration);
            ...
            if (checkIcon != null)
            {
                Tizen.Log.Info("MediaHub", "checkIcon != null, bind checkIcon to selected in animation.");
                ...
                Tizen.Log.Info("MediaHub", "isSelected = " + isSelected + ", selectedInOpacity = " + selectedInOpacity + ", selectedOutOpacity = " + selectedOutOpacity);
                if (isSelected)
                {
        ...
        {
            Tizen.Log.Info("MediaHub", "Update Focused state");
            ApplyBgView();
        ...
        {
            Tizen.Log.Info("MediaHub", "Play Focused Animation");
            if (isFocused)
            {
        ...
        {
            Tizen.Log.Info("MediaHub", "Update Selected state");
            if (checkIcon != null)
            {
                if (isSelected)
                {
                    checkIcon.RaiseToTop();// temp add for checkicon is above mainIcon, like single02/single04
                    Tizen.Log.Info("MediaHub", "show CheckIcon");
                    checkIcon.Opacity = 0;
                }
                else
                {
                    Tizen.Log.Info("MediaHub", "Hide CheckIcon");
                    checkIcon.Opacity = 1.0f;
                }
            }
        ...
        {
            Tizen.Log.Info("MediaHub", "Play Selected Animation, isSelected = " + isSelected);
            if (isSelected)
            {
        ...
        {
            Tizen.Log.Info("MediaHub", "Update Enabled state");
            UpdateMainTextFontStyleByState();
            PlayEnableAnimation();
        }
        ...
        {
            Tizen.Log.Info("MediaHub", "Play Enabled Animation");
            if (isEnabled)
            {
        ...
        private void UpdateMainTextFontStyleByState()
        {
            ...
            Tizen.Log.Info("MediaHub", "Update MainText FontStyle");
            ApplyMainTextFontStyle();
        }
        ...
        private void ApplyCheckIconPosition()
        {
            ...
            Tizen.Log.Info("MediaHub", "Apply CheckIcon Position");
