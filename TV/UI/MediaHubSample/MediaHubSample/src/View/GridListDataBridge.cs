...
namespace Tizen.NUI.MediaHub
{
    ...
    class GridListDataBridge : GridBridge
    {
        ...
        public override void FocusChange(int groupIndex, int itemIndex, View view, bool FlagFocused, bool bSelected = false)
        {
            ...
            Tizen.Log.Info("MediaHub", "FocusChange in GridView!");
            FootView footView = CommonResource.FootView;

            if (FlagFocused == true)
            {
                Tizen.Log.Info("MediaHub", " Gridlist view onFocus change index:" + itemIndex);
                ...
                Tizen.Log.Info("MediaHub", " Gridlist view onFocus change footModel.ItemType:" + footModel.ItemType);
            }
           ...
           // int itemType = GetItemType(groupIndex, itemIndex);
            ...
            switch (this.viewType)
            {
                case ContentViewType.ALL:
                    ...
                    Tizen.Log.Info("MediaHub", "[ListView] will create ALL itemView");
        ...
        {
            Tizen.Log.Info("MediaHub", "Gridlistview UpdateItem  groupIndex:" + groupIndex + " itemIndex:" + itemIndex);
            if (view == null)
            {
                Tizen.Log.Info("MediaHub", "Gridlistview UpdateItem  view == null");
                return;
            }
