...
namespace Tizen.NUI.MediaHub
{
    ...
    public class MainPage : IExample
    {
        ...
        public MainPage()
        {
            ...
            Tizen.Log.Info("MediaHub", "Create MainPage");
        }
        ...
        private void OnInitialize()
        {
            ...
            SetFocusRule();
            Activate();
            Tizen.Log.Info("MediaHub", "OnInitialize!!!!!!!!!!!!!!");
        }
        ...
        {
            Tizen.Log.Info("MediaHub", "setFocusRule for GridView and FootView");
            if (gridView == null)
            {
                Tizen.Log.Info("MediaHub", "setFocusRule  gridList == null  just return");
                return;
            }
        ...
        private void CreateBGImage()
        {
            ...
            Window.Default.GetDefaultLayer().Add(bgView);
            CommonResource.BGView = bgView;
        }
        ...
        {
            Window.Default.GetDefaultLayer().Remove(bgView);
        }
    }
