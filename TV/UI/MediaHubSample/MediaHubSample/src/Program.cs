...
namespace Tizen.NUI.MediaHub
{
    ...
    public class Program : NUIApplication
    {
        ...
        private void OnInitialize()
        {
            ...
            CreateHeadView();
            CreateContentView();
            Window.Default.KeyEvent += InstanceKey;
        ...
        private void AppBack(object source, Window.KeyEventArgs e)
        {
            if (e.Key.State == Key.StateType.Down)
            {
                ...
                {
                    Tizen.Log.Info("MediaHub", "XF86Back");
                    this.Exit();
                }
            }
        }
        ...
        private void CreateContentView()
        {
            ...
            Tizen.Log.Info("MediaHub", "Create Grid for first Page!");
        ...
        private bool DoTilePress(object source, View.KeyEventArgs e)
        {
            ...
            if (e.Key.State == Key.StateType.Down)
            {
                if (e.Key.KeyPressedName == "Return")
                {
                    ...
                    {
                        //ShowMainPage
                        Tizen.Log.Info("MediaHub", " Item 3 Clicked!!!!!!!!!!!!!!");
                        Deactivate();
        ...
        private void InstanceKey(object sender, Window.KeyEventArgs e)
        {
            if (e.Key.State == Key.StateType.Down)
            {
                if (e.Key.KeyPressedName == "XF86Back")
                {
                    Tizen.Log.Info("MediaHub", e.Key.KeyPressedName);
                    if (!isHomePageFlag)
                    {
                        this.Activate();
                    }
