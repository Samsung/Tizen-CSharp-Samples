    ...
    public class EventCallBack
    {
        ...
        public void OnItemPress(GridView view)
        {
            ...
            if (view != null)
            {
                ...
                {
                    Tizen.Log.Fatal("MediaHub", "onItemPress error: " + e.Message);
                }
                ...
                {
                    Tizen.Log.Fatal("MediaHub", "onItemPress exception error: " + e2.Message);
                }
        ...
        {
            Tizen.Log.Info("MediaHub", "editModeItemPress itemIndex:" + itemIndex + ", groupIndex:" + groupIndex);
