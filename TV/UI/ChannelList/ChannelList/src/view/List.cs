    ...
    public class List : View
    {
        ...
        private void DeleteItem(int fromItemIndex, int deleteItemNum)
        {
            ...
            if (mHeadItemIndex <= toItemIndex && mTailItemIndex >= fromItemIndex)
            {
                ...
                bool flagScrollItem = CalItemGroupPosByFocusItemIndex(mCurFocusItemIndex, out itemGroupPosY);
                mItemGroupRect.Y = itemGroupPosY;
        ...
        /// <param name="itemGroupPosY">the item group position</param>
        ...
        private bool CalItemGroupPosByFocusItemIndex(int focusIndex, out float itemGroupPosY)
        {
            ...
            {
                needScroll = true;
                yPos += startFocusRange - destItemRectOnList.Y;
            }
            else if (destItemRectOnList.Bottom() > endFocusRange)
            {
                needScroll = true;
                yPos += endFocusRange - destItemRectOnList.Bottom();
            }
