...
namespace ListSample
{
    ...
    public class ChannelListSample : NUIApplication
    {
        ...
        {
            base.OnCreate();
            Window.Default.BackgroundColor = new Color(0.38f, 0.46f, 0.54f, 1.0f);
            windowSize = Window.Default.Size;
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            Window.Default.GetDefaultLayer().Add(contentLayout);
        ...
        private void CreateSelectContent()
        {
            ...
            Window.Default.GetDefaultLayer().Add(selectContentLayout);
