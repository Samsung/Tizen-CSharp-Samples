...
namespace FirstScreen
{
    ...
    public class MenuScreen : NUIApplication
    {
        ...
        private void OnKeyboardPreFocusChangeSignal(object source, FocusChangingEventArgs e)
        {
        ...
        private void OnInitialize()
        {
            ...
            // Initialize FocusChanging event of KeyboardFocusManager
            _keyboardFocusManager = FocusManager.Instance;
            _keyboardFocusManager.FocusChanging += OnKeyboardPreFocusChangeSignal;
        ...
        private void AppBack(object source, Window.KeyEventArgs e)
        {
            ...
            {
                Tizen.Log.Info("FirstScreen", e.Key.KeyPressedName);
