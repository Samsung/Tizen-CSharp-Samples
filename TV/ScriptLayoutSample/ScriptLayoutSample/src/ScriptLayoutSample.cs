...
namespace ScriptLayoutSample
{
    ...
    class ScriptLayoutSample : NUIApplication
    {
        ...
        private void Initialize()
        {
            ...
            content.Position2D = new Position2D(100, 200);
            content.Size2D = new Size2D(1200, 550);
            ...
            mImagePlacement.Position2D = new Position2D(1300, 200);
            ...
            defaultThemeButton.Position2D = new Position2D(200, 900);
            ...
            customThemeButton.Position2D = new Position2D(900, 900);
